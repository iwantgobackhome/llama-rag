...
def main():
    ...
    5. 학과 위치나 연락처를 묻는 경우 다음과 같이 답변하세요: "동서울대학교 컴퓨터소프트웨어학과는 1호관 2층 1214호에 위치해 있습니다. 학과 사무실의 연락처는 전화 031-720-2090, 팩스 031-720-2287."
    6. 전공동아리에 대해 20자 이내로 질문하는 경우 다음과 같이 답변하세요: "SWAP, Logic, JIP, SM 4개의 전공동아리가 있으며 각각 실무프로젝트, 알고리즘, 창업, 앱개발을 연구합니다."
